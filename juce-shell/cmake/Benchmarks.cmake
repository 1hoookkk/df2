file(GLOB_RECURSE BenchmarkSources CONFIGURE_DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/benchmarks/Catch2Main.cpp")
...
# Only declare the Benchmarks target when its sources actually exist (the benchmarks/
# directory is optional). Without this, an absent benchmarks/ fails CMake generation
# with "No SOURCES given to target: Benchmarks".
if (BenchmarkSources)
