...
public:
    ...
    // Keep the compact-face gesture voice wired to the restored display
    // implementation. It is dormant in the reference beauty shot.
...

        {
            ...
            if (amountCueAlpha > 0.01f)
            {
                ...
                g.drawText (amountCueText,
                            juce::Rectangle<float> (glass.getX() + 8.0f, glass.getY() + 4.0f,
                                                    190.0f, 14.0f),
