...
// A small, thin two-up selector ("1" / "2") printed into the display glass.
// It is LCD-flat screen ink, not a readout bevel floating above the curve.
...
public:
    ...
    std::function<void (int)> onSelect;   // 0-based cell index
