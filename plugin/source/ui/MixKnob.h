...
// Small secondary MIX control for the header. It drives the existing amount
// parameter: MIX is the product-facing name for the identity-to-full-body
// blend, so the DSP contract does not gain a duplicate parameter.
