...
public:
    static UiLayout defaults()
    {
        ...
        layout.colours["accent"]             = juce::Colour (0xffd9ef8a);
        layout.colours["curveColour"]        = juce::Colour (0xffd9ef8a);
        layout.colours["curveHighlight"]     = juce::Colour (0xffeaffb0);
        layout.colours["telemetry"]          = juce::Colour (0xff8895a8);
        layout.colours["rollerIllumination"] = juce::Colour (0xff3c7fa6);
        layout.colours["modulationLamp"]     = juce::Colour (0xff3c7fa6);
        layout.colours["phosphor"]           = juce::Colour (0xff1b1715);
        layout.colours["amber"]              = juce::Colour (0xffd9ef8a);
        layout.colours["dashed"]             = juce::Colour (0xff515775);
        layout.colours["screenEdge"]         = juce::Colour (0xff1a1d28);
